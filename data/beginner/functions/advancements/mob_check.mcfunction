...
execute as @a[nbt={SelectedItem:{id:"minecraft:wheat"}}] at @s if entity @e[type=#lured_by_wheat,distance=..5] run advancement grant @a only beginner:phase_shelter/lure_wheat_animals
